...
| [`rmse.py`](rmse.py) | Independent RMSE accuracy assessment from `reconstruction.topocentric.json` + GCP/CHK lists. Generates an HTML report with annotated ortho crops, outlier detection, and optional uncertainty overlay ([example](examples/rmse_report.html)) |
